...
//                                $patientrow = $database->query("select  * from  patient;");
                                    $patientrow = $database->query("select  * from  tbl_peer;");
                                $doctorrow = $database->query("select  * from  tbl_peer;");
                                $appointmentrow = $database->query("select  * from  tbl_request;");
                                $schedulerow = $database->query("select  * from  tbl_request;");
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../../edoc-doctor-appointment-system-main/img/icons/doctors-hover.svg');"></div>
                                                    </div>
                                                </td>
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../../edoc-doctor-appointment-system-main/img/icons/patients-hover.svg');"></div>
                                                    </div>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; ">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="margin-left: 0px;background-image: url('../../edoc-doctor-appointment-system-main/img/icons/book-hover.svg');"></div>
                                                    </div>
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;padding-top:21px;padding-bottom:21px;">
                                                        <div>
                                                                ...
                                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../../edoc-doctor-appointment-system-main/img/icons/session-iceblue.svg');"></div>
                                                    </div>
                                                </td>
                                        ...
                                        <tbody>
                                            ...
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    <br><br><br><br>
                                                    <center>
                                                    <img src="../../edoc-doctor-appointment-system-main/img/notfound.svg" width="25%">
